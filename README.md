...
<body>
    ...
    <form action="submit_form.php" method="post">
        ...
        <input type="text" id="how_hear" name="how_hear" required>
        <br>
        <br>

        <label for="scholarship_code">Scholarship/Discount Code (optional):</label>
        <input type="text" id="scholarship_code" name="scholarship_code">
        <br>
        <br>
